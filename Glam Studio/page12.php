...
<div id="num">Appointment No.: 25</div>
<div id="nm">Name: Mohita Rauthan</div>
<div id="phone">Phone No.: 8954785611</div>
<div id="date">Date: 2021-05-20</div>
<table>
<tr>
<th>Item </th>
<th>Description</th>
...
$query = "SELECT `Appoint_no.`, `Services`, `Cost` FROM `detail` WHERE Name ='Mohita Rauthan'"; 
$result = $conn->query($query);
if($result -> num_rows > 0)
{
	while($row=$result->fetch_assoc()){
		echo "<tr><td> 1 </td><td>" .$row["Services"]."</td><td>" .$row["Cost"]. 
		"</td><td> 20% </td><td>6400</td></tr>";
	}
	echo "</table>";
}
else{
...
<div id="total"><b><u>Grant Total: 6400</u></b></div>
